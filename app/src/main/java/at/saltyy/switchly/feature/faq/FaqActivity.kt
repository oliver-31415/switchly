...
class FaqActivity : AppCompatActivity() {
    ...
    private fun buildFaqItems(): List<FaqListItem> {
        ...
        quick.item(R.string.faq_q_troubleshooting_first_steps, R.string.faq_a_troubleshooting_first_steps, R.drawable.help_24)
        ...
        quick.item(R.string.faq_q_quick_actions_tiles_widgets, R.string.faq_a_quick_actions_tiles_widgets, R.drawable.dashboard_24)
        ...
        quick.item(R.string.faq_q_switchly_disabled_no_blocking, R.string.faq_a_switchly_disabled_no_blocking, R.drawable.toggle_off_24)
        quick.item(R.string.faq_q_location_schedules_reliability, R.string.faq_a_location_schedules_reliability, R.drawable.location_on_24)
        quick.item(R.string.faq_q_maps_empty_gray, R.string.faq_a_maps_empty_gray, R.drawable.location_on_24)
        ...
        detailed.item(R.string.faq_q_qr_internal_external, R.string.faq_a_qr_internal_external, R.drawable.qr_code_24)
        ...
        detailed.item(R.string.faq_q_control_channel_still_works, R.string.faq_a_control_channel_still_works, R.drawable.tune_24)
        ...
        detailed.item(R.string.faq_q_location_schedules_reliability, R.string.faq_a_location_schedules_reliability, R.drawable.location_on_24)
        ...
        detailed.item(R.string.faq_q_troubleshooting_first_steps, R.string.faq_a_troubleshooting_first_steps, R.drawable.help_24)
        detailed.item(R.string.faq_q_switchly_disabled_no_blocking, R.string.faq_a_switchly_disabled_no_blocking, R.drawable.toggle_off_24)
        ...
        detailed.item(R.string.faq_q_maps_empty_gray, R.string.faq_a_maps_empty_gray, R.drawable.location_on_24)
        ...
        detailed.item(R.string.faq_q_quick_actions_tiles_widgets, R.string.faq_a_quick_actions_tiles_widgets, R.drawable.dashboard_24)
        detailed.item(R.string.faq_q_shortcuts_widgets, R.string.faq_a_shortcuts_widgets, R.drawable.apps_24)
        ...
        detailed.item(R.string.faq_q_developer_mode_logging, R.string.faq_a_developer_mode_logging, R.drawable.info_24)
        ...
        detailed.item(R.string.faq_q_support_report_contents, R.string.faq_a_support_report_contents, R.drawable.mail_24)
